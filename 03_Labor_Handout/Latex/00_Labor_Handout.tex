...
%Bild in Tabelle
\newcommand{\tablebild}[2]{
\raisebox{-\totalheight}{\includegraphics[width=#1\textwidth]{img/#2}}}

%Anmerkung
\newcommand{\anmerkung}[1]{\vspace*{3mm}
\textcolor{red}{#1}}
...
\include{03_sicheitsmasnahmen}

\include{04_geraete}

\include{05_versuchstande}

%\include{06_chemie}

\include{07_fehlerquellen}
