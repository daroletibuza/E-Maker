...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.4\textwidth]{img/volumen_eppendorf}
	\caption{Schematische Umgangsweise mit einer Kolbenhubpipette}
	\label{fig:eppen_Vol}
\end{figure}
\FloatBarrier

\tipp{Wichtig}{Es ist stets darauf zu achten, dass egal welche Pipette genutzt wird diese nicht liegen darf ! Sie werden in eine dafür vorgesehene Halterung gestellt oder eingehangen.}
...
\begin{figure}[h!]
	\begin{minipage}[t]{0.45\textwidth}
		\mminibild{steckdose}{Steckdose (Wechselstrom)}{0.55}{0pt}
	\end{minipage}
	\hfill
	\hspace{1mm}
	\begin{minipage}[t]{0.45\textwidth}
 		\mminibild{cee-stecker.png}{CEE-Stecker (Drehstrom)}{0.7}{0pt}
	\end{minipage}
\end{figure}
\FloatBarrier

\anmerkung{Bilder und Erklärung der zeitlich verschobenen Phasen ?}
